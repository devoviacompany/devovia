  ...
  return (
    <Container className="border-divide flex flex-col items-center border-x pt-12">
      ...
      <SubHeading as="p" className="mx-auto mt-6 max-w-lg px-2">
        Answers to common questions about Devovia from billing to integrations and AI models. Still need help?
      </SubHeading>
      <div className="mt-8 mb-12 flex w-full flex-col justify-center gap-4 px-4 sm:flex-row">
        <Button variant="default" className="w-full sm:w-auto">
          <Link href="https://devhub.devovia.vercel.app/docs">Read Docs</Link>
        </Button>
        <Button
          variant="secondary"
