...
import { PixelatedCanvas } from "@/components/site/pixelated-canvas";
  ...
  const tabs = [
    {
      title: "Plan & design",
      description:
        "Use AI-assisted planning and a visual UI builder to map requirements and assemble real components fast.",
      icon: FirstIcon,
      id: "workflow",
      skeleton: <DesignYourWorkflowSkeleton />,
    },
    {
      title: "Connect services & models",
      description:
        "Hook up auth, databases, payments, notifications, and AI providers like OpenAI, Cohere, and Gemini.",
      icon: SecondIcon,
      id: "tools",
    ...
    },
    {
      title: "Deploy & scale",
      description:
        "Preview, test, and launch to Vercel or Railway in minutes with environments, logs, and rollbacks.",
      icon: ThirdIcon,
      id: "deploy",
  ...
  return (
    <Container className="border-divide border-x">
      <div className="flex flex-col items-center pt-16">
        ...
        <SectionHeading className="mt-4">Build end-to-end with AI</SectionHeading>

        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          Plan on a whiteboard, design with shadcn/ui, connect services and AI models, then deploy with one click all inside Devovia.
        </SubHeading>
        {/* Desktop Tabs */}
