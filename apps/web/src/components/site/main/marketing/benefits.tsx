...
import { RealtimeSyncIcon } from "@/components/site/icons/bento-icons";
import { DivideX } from "@/components/site/divide";
import { Logo } from "@/components/global/logo";
import { OpenAILogo, SlackLogo } from "@/components/site/icons/general";
import { IconBlock } from "@/components/site/common/icon-block";
import { HorizontalLine } from "@/components/site/common/horizontal-line";
import { VerticalLine } from "@/components/site/common/vertical-line";
  ...
  const benefits = [
    {
      title: "Launch Faster",
      description:
        "From idea to deployed app in hours with AI-assisted scaffolding and sensible defaults.",
      icon: <RocketIcon className="text-brand size-6" />,
    },
    {
      title: "Iterate Rapidly",
      description:
        "Edit UI, APIs, and AI behaviors in one place with instant preview and safe changes.",
      icon: <RealtimeSyncIcon className="text-brand size-6" />,
    },
    {
      title: "Scale Smarter",
      description:
        "Environments, logs, metrics, and rollbacks built-in for confident releases.",
      icon: <GraphIcon className="text-brand size-6" />,
    },
    {
      title: "Reuse Intelligence",
      description:
        "Share components, templates, and AI prompts across projects and teams.",
      icon: <ReuseBrainIcon className="text-brand size-6" />,
    },
    {
      title: "Prevent Breakdowns",
      description:
        "Type safe APIs, tests, and guardrails reduce production issues before they happen.",
      icon: <ShieldIcon className="text-brand size-6" />,
    },
    {
      title: "Automate More",
      description:
        "Hook into auth, payments, notifications, and workflows with clicks not glue code.",
    ...
    <Container className="border-divide relative overflow-hidden border-x px-4 py-20 md:px-8">
      <div className="relative flex flex-col items-center">
        ...
        <SectionHeading className="mt-4">
          Ship full stack apps 10x faster
        </SectionHeading>

        <SubHeading as="p" className="mx-auto mt-6 max-w-lg">
          Plan, design, develop, test, and deploy from one place. Devovia unifies frontend, backend, and AI so you move from idea to production in hours.
        </SubHeading>
      </div>
...
const MiddleCard = () => {
  const texts = ["Project scaffolded", "API routes generated", "Tests passed"];
    ...
    <div className="relative flex min-h-40 flex-col justify-end overflow-hidden rounded-lg bg-gray-50 p-4 md:p-5 dark:bg-neutral-900">
      ...
      <div className="flex items-center justify-center">
        ...
        <div className="relative h-16 w-16 shrink-0 overflow-hidden rounded-md bg-gray-200 p-px shadow-xl dark:bg-neutral-700">
          ...
          <div className="via-brand absolute inset-0 scale-[1.4] animate-spin rounded-full bg-conic [background-image:conic-gradient(at_center,transparent,var(--color-primary)_20%,transparent_30%)] [animation-delay:1s] [animation-duration:2s]"></div>
