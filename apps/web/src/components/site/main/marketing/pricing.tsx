...
import { SlidingNumber } from "@/components/site/sliding-number";
import { CheckIcon } from "@/components/site/icons/card-icons";
...
export const Pricing = () => {
  ...
  return (
    <section>
      <Container className="border-divide flex flex-col items-center justify-center border-x pt-20 pb-20">
        <Badge text="Pricing" />
